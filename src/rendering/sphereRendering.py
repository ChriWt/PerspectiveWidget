...
class SphereRendering(ShapeRendering):
    ...
    def __apply_projection(self, vertex: Vector3) -> None:
        origin = self._sphere.get_origin()
        ...
        translated_vertex_4d = self._translate_vertex(rotated_vertex_4d, self._sphere._velocity)
        ...
        # return Vector3(projected_vertex[0] * scale + offset_x, projected_vertex[1] * scale + offset_y, projected_vertex[2])
    ...
    def __apply_rotation(self, vertex_4d: array) -> array:
        rotated_vertex_4d = self._rotation_matrix_y(self._sphere._rotation_y) @ \
                            self._rotation_matrix_x(self._sphere._rotation_x) @ \
                            self._rotation_matrix_z(self._sphere._rotation_z) @ \
                            vertex_4d
